...
import model.core
import model.rwkv
import model.experimental.rwkv7_0
...
cli.Config(
    ...
    model_factory = lambda: model.core.Decoder(
        ...
        layer_factory=lambda: model.core.TransformerLayer(
            self_attention_sublayer_factory = lambda: model.experimental.rwkv7_0.RWKV7_0_AttentionSubLayer(),
