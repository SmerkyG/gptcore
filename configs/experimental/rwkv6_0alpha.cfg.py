...
import model.core
import model.rwkv
import model.experimental.rwkv6_0alpha
...
LOG_PROJECT = 'gptcore'
LOG_NAME = 'RWKV6.0Alpha L12D768H12CM3Adam'
        ...
        layer_factory=
            #lambda: model.core.GradientCheckpointing(module_factory = 
                lambda: model.core.TransformerLayer(
                    self_attention_sublayer_factory = lambda: model.experimental.rwkv6_0alpha.RWKV6_0_Alpha_AttentionSubLayer(),
