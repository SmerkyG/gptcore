...
import model.experimental.gptalpha_based
...
LOG_PROJECT = 'gptcore'
LOG_NAME = 'GPTAlphaBased L12D768H12CM2V1Adam'
    ...
    model_factory = lambda: model.core.Decoder(
        ...
        layer_factory=lambda: model.core.TransformerLayer(
            self_attention_sublayer_factory = lambda: model.core.AttentionSubLayer(
                attention_factory = lambda:model.experimental.gptalpha_based.ApproximatedDecayedAttention(),
            ),
