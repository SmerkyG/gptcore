...
cli.Config(
    ...
    model_factory = lambda: model.core.Decoder(
        hparams = model.hparams.HParams(
            ...
            self_attention_sublayer_factory = lambda: model.rwkv.RWKV4_AttentionSubLayer(),
            feedforward_sublayer_factory = lambda: model.rwkv.RWKV_ChannelMixSubLayer(),
        ),
    ),
    loss_wrapper_factory = lambda: model.rwkv.L2Wrap(),
    ...
    trainer_factory = lambda: lightning.Trainer(
        ...
        logger = [
            ...
            lightning.pytorch.loggers.WandbLogger(project='pico', name='RWKV4 L12D768H12CM2Adam'),
        ],
        callbacks = [
